                    ...
                    <div class="card-body">
                        <form action="{{ route('image.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-7">
                                    @if ($image->user->image)                            
                                        <div class="container-avatar">
                                            ...
                                            <img src="{{ route('image.file', ['filename' => $image->image_path]) }}" class="avatar" alt="avatar usuario" />
                                        </div>
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <textarea type="text" name="description" id="description" class="form-control {{$errors->has('description') ? 'is-invalid' : ''}}" required>{{$image->description}}</textarea>
